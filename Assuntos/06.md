...
6. Lê 3 números que representam os ângulos de um triângulo e diz se
   ...
   As opções não são exclusivas, um triângulo pode ser retângulo e escaleno, por exemplo.
...
1. Faça um programa que calcula o IMC, a partir da altura e pesi informados pelo usuário. O programa deve informar a classificação (normal, obeso, etc), além do índice numérico. Use seleção múltipla com ifs aninhados.
